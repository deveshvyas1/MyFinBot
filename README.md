...
- `/status` - shows how much cash to hold today (with a breakdown of rent, electricity, tiffin, and daily defaults) to cover essentials through the first of next month.
